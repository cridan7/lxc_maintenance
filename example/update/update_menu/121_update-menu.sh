#!/usr/bin/env bash
# Auto-generated update menu for CTID 121

# Define URLs for each update script
PI_HOLE_URL="https://github.com/community-scripts/ProxmoxVE/raw/main/ct/pihole.sh"
UNBOUND_URL="https://github.com/community-scripts/ProxmoxVE/raw/main/ct/unbound.sh"
...
while true; do
  ...
  case "$choice" in
    ...
    5) run_update "$PI_HOLE_URL" ;;
    6) run_update "$UNBOUND_URL" ;;
