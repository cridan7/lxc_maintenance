#!/usr/bin/env bash
# Auto-generated update menu for CTID 101

set -euo pipefail

# Define URLs for each update script
QBITTORRENT_URL="https://github.com/community-scripts/ProxmoxVE/raw/main/ct/qbittorrent.sh"
...
while true; do
  ...
  case "$choice" in
    ...
    5) run_update "$QBITTORRENT_URL" ; pause ;;
