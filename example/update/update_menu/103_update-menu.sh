#!/usr/bin/env bash
# Auto-generated update menu for CTID 103

# Define URLs for each update script
JELLYFIN_URL="https://github.com/community-scripts/ProxmoxVE/raw/main/ct/jellyfin.sh"
