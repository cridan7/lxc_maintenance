...
LOCAL_PVE_SCRIPTS_URL="https://github.com/community-scripts/ProxmoxVE/raw/main/ct/pve-scripts-local.sh"
...
while true; do
  ...
  case "$choice" in
    ...
    5) run_update "$LOCAL_PVE_SCRIPTS_URL" ;;
