#!/usr/bin/env bash
# Auto-generated update menu for CTID 111

# Define URLs for each update script
ZIGBEE2MQTT_URL="https://github.com/community-scripts/ProxmoxVE/raw/main/ct/zigbee2mqtt.sh"
...
while true; do
  ...
  case "$choice" in
    ...
    5) run_update "$ZIGBEE2MQTT_URL" ;;
    6) run_update "$FILEBROWSER_URL" ;;
