#!/usr/bin/env bash
# Auto-generated update menu for CTID 104

# Define URLs for each update script
HYPERHDR_URL="https://github.com/community-scripts/ProxmoxVE/raw/main/ct/hyperhdr.sh"
