#!/usr/bin/env bash
# Auto-generated update menu for CTID 112

# Define URLs for each update script
MQTT_URL="https://github.com/community-scripts/ProxmoxVE/raw/main/ct/mqtt.sh"
