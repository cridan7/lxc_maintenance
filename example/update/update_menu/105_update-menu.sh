#!/usr/bin/env bash
# Auto-generated update menu for CTID 105

# Define URLs for each update script
HYPERION_URL="https://github.com/community-scripts/ProxmoxVE/raw/main/ct/hyperion.sh"
