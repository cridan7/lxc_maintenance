#!/usr/bin/env bash
# Auto-generated update menu for CTID 127

# Define URLs for each update script
ACTUAL_URL="https://github.com/community-scripts/ProxmoxVE/raw/main/ct/actualbudget.sh"
