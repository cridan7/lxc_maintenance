#!/usr/bin/env bash
# Auto-generated update menu for CTID 123

# Define URLs for each update script
HOMEPAGE_URL="https://github.com/community-scripts/ProxmoxVE/raw/main/ct/homepage.sh"
