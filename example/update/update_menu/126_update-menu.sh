#!/usr/bin/env bash
# Auto-generated update menu for CTID 126

# Define URLs for each update script
GUACAMOLE_URL="https://github.com/community-scripts/ProxmoxVE/raw/main/ct/apache-guacamole.sh"
