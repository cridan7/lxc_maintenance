#!/usr/bin/env bash
# Auto-generated update menu for CTID 131

# Define URLs for each update script
NEXTCLOUDPI_URL="https://github.com/community-scripts/ProxmoxVE/raw/main/ct/nextcloudpi.sh"
